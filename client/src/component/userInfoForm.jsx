...
import { Button, Checkbox, Col, Form, Radio, Select, Steps } from 'antd';
    ...
    const steps = [
        {
            title: '1',
            content: (
                <Form.Item label="Are you a vegeterian?" name="diet_preferance" rules={[
                    {
                        required: true,
                        message: 'Please select your Diet Preferance!',
                    },
                ]}>
